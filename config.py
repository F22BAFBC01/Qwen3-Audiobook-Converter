...
VOICE_CLONE_MAX_CHUNK_CHARS = 500  # Gradio maximum; API splits at punctuation within target_text
VOICE_CLONE_CHUNK_GAP = 0.25  # Gap between API-internal chunks in seconds
